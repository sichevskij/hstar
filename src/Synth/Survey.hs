...
data IPHAS   = IPHAS   deriving (Show,Read)
...
data Hα s = Hα s Val deriving (Show,Functor,Read)
...
data RHα s = RHα s Val deriving (Show,Functor)
...
data RI s = RI s Val deriving (Show,Functor)
