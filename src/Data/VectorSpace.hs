...
instance ( VectorSpace a1, s ~ Scalar a1
         , VectorSpace a2, s ~ Scalar a2
         , VectorSpace a3, s ~ Scalar a3
         , VectorSpace a4, s ~ Scalar a4
         , VectorSpace a5, s ~ Scalar a5 )
    => VectorSpace (a1,a2,a3,a4,a5) where
  type Scalar (a1,a2,a3,a4,a5) = Scalar a1
  s *^ (a1,a2,a3,a4,a5) = (s*^a1,s*^a2,s*^a3,s*^a4,s*^a5)

instance ( InnerSpace a1, s ~ Scalar a1
         , InnerSpace a2, s ~ Scalar a2
         , InnerSpace a3, s ~ Scalar a3
         , InnerSpace a4, s ~ Scalar a4
         , InnerSpace a5, s ~ Scalar a5
         , AdditiveGroup s )
    => InnerSpace (a1,a2,a3,a4,a5) where
...
instance ( VectorSpace a1, s ~ Scalar a1
         ...
         , VectorSpace a4, s ~ Scalar a4
         , VectorSpace a5, s ~ Scalar a5
         , VectorSpace a6, s ~ Scalar a6
         , VectorSpace a7, s ~ Scalar a7
         , VectorSpace a8, s ~ Scalar a8 )
    => VectorSpace (a1,a2,a3,a4,a5,a6,a7,a8) where
  type Scalar (a1,a2,a3,a4,a5,a6,a7,a8) = Scalar a1
  s *^ (a1,a2,a3,a4,a5,a6,a7,a8) = (s*^a1,s*^a2,s*^a3,s*^a4,s*^a5,s*^a6,s*^a7,s*^a8)
...
instance ( InnerSpace a1, s ~ Scalar a1
         ...
         , InnerSpace a4, s ~ Scalar a4
         , InnerSpace a5, s ~ Scalar a5
         , InnerSpace a6, s ~ Scalar a6
         , InnerSpace a7, s ~ Scalar a7
         , InnerSpace a8, s ~ Scalar a8
         , AdditiveGroup s )
    => InnerSpace (a1,a2,a3,a4,a5,a6,a7,a8) where
...
instance ( VectorSpace a1, s ~ Scalar a1
         ...
         , VectorSpace a7, s ~ Scalar a7
         , VectorSpace a8, s ~ Scalar a8
         , VectorSpace a9, s ~ Scalar a9
         , VectorSpace a10, s ~ Scalar a10 )
    => VectorSpace (a1,a2,a3,a4,a5,a6,a7,a8,a9,a10) where
  type Scalar (a1,a2,a3,a4,a5,a6,a7,a8,a9,a10) = Scalar a1
  s *^ (a1,a2,a3,a4,a5,a6,a7,a8,a9,a10) = (s*^a1,s*^a2,s*^a3,s*^a4,s*^a5,s*^a6,s*^a7,s*^a8,s*^a9,s*^a10)
...
instance ( InnerSpace a1, s ~ Scalar a1
         ...
         , InnerSpace a7, s ~ Scalar a7
         , InnerSpace a8, s ~ Scalar a8
         , InnerSpace a9, s ~ Scalar a9
         , InnerSpace a10, s ~ Scalar a10
         , AdditiveGroup s )
    => InnerSpace (a1,a2,a3,a4,a5,a6,a7,a8,a9,a10) where
